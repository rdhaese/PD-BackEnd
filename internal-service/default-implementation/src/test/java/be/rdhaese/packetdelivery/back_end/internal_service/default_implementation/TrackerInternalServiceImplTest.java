...
public class TrackerInternalServiceImplTest extends TestCase {
    ...
    public void testGetCompanyAddress() throws Exception {
        ...
        //Test
        assertEquals(longLat, trackerInternalService.getCompanyAddress());
    ...
    public void testGetPacketAddressForPacketId() throws Exception {
        ...
        //Test
        assertNull(trackerInternalService.getPacketAddress("unknown id"));
        assertEquals(longLat, trackerInternalService.getPacketAddress("packetId"));
    ...
    public void testGetLocationUpdatesForPacketId() throws ParseException {
        ...
        List<LocationUpdate> locationUpdates = Arrays.asList(
                createLocationUpdate(dateFormat.parse("17/04/2016"), createLongLat(1D, 2D)),
                createLocationUpdate(dateFormat.parse("16/04/2016"), createLongLat(3D, 4D)),
                createLocationUpdate(dateFormat.parse("20/04/2016"), createLongLat(5D, 6D))
        );
        ...
        //Test
        assertNull(trackerInternalService.getLocationsUpdates("unknown Id"));
        assertEquals(3, trackerInternalService.getLocationsUpdates("packetId").size());
    ...
    public void getRemarksForPacketId() throws ParseException {
        ...
        List<Remark> remarks = Arrays.asList(
                createRemark(dateFormat.parse("17/04/2016"), "remark1"),
                createRemark(dateFormat.parse("16/04/2016"), "remark2262625"),
                createRemark(dateFormat.parse("20/04/2016"), "remark3uintrdrtsws")
        );
        List<DeliveryRound> deliveryRounds = Arrays.asList(
                createDeliveryRound(new ArrayList<>(), new ArrayList<>(), new ArrayList<>(), null),
        ...
        //Test
        assertNull(trackerInternalService.getRemarks("unknown Id"));
        assertEquals(3, trackerInternalService.getRemarks("packetId").size());
        verify(deliveryRoundRepository, times(2)).getOngoingRounds();
    }
    ...
    public void testGetAmountOfPacketsLeftBeforeForPacketId() throws Exception {
        ...
        //Test
        assertNull(trackerInternalService.getAmountOfPacketsLeftBefore("unknown id"));
        assertEquals(0, trackerInternalService.getAmountOfPacketsLeftBefore("packetId3").intValue());
        assertEquals(1, trackerInternalService.getAmountOfPacketsLeftBefore("packetId1").intValue());
        assertEquals(2, trackerInternalService.getAmountOfPacketsLeftBefore("packetId2").intValue());
